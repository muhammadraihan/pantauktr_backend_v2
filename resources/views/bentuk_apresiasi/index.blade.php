...
@section('title', 'Bentuk Apreasiasi Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Bentuk Apreasiasi</span>
        <small>
            Module for manage bentuk Apreasiasi.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Bentuk Apreasiasi <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('bentuk_apresiasi.create')}}"><i class="fal fa-plus-circle">
                        </i>
...
<script>
    $(document).ready(function(){
        ...
        $('#datatable').DataTable({
            ...
            "order": [[ 0, "asc" ]],
            "ajax":{
                url:'{{route('bentuk_apresiasi.index')}}',
                type : "GET",
                dataType: 'json',
                error: function(data){
                    console.log(data);
