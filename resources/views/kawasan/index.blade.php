...
@section('title', 'Kawasan Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-tasks'></i> Module: <span class='fw-300'>Kawasan</span>
        <small>
            Module for manage kawasan.
        </small>
    </h1>
</div>
<div class="row">
        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('kawasan.create')}}"><i class="fal fa-plus-circle">
                        </i>
