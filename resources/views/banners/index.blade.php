...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-image'></i> Module: <span class='fw-300'>Banner</span>
        <small>
            Module for manage Banner for apps.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Banner <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('banner.create')}}"><i class="fal fa-plus-circle">
                        </i>
