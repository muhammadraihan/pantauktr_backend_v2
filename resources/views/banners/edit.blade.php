...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$banner->uuid}}</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['banner.update',$banner->uuid],'method' => 'PUT','class' => 'needs-validation','enctype' => 'multipart/form-data','novalidate']) !!}
                    ...
                    <div class="form-group col-sm-6 col-xl-4">
                        ...
                        <select class="js-bg-color custom-select select2" name="status">
                                @if ($banner->status == 1)
                                <option value="{{$banner->status}}">Aktif</option>
                                @else
                                <option value="{{$banner->status}}">Non Aktif</option>
                                @endif
