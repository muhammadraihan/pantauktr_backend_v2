...
@section('title', 'Jenis Pelanggaran Edit')
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('name',$pelanggaran->name,['placeholder' => 'Nama Pelanggaran','class' => 'form-control '.($errors->has('name') ? 'is-invalid':''),'required'])}}
                        @if ($errors->has('name'))
