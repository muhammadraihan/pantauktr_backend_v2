...
@section('title', 'Bentuk Pelanggaran Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Bentuk Pelanggaran</span>
        <small>
            Module for manage bentuk pelanggaran.
        </small>
    </h1>
</div>
<div class="row">
