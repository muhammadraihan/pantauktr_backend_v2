...
@section('title', 'Instagram Create')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Instagram</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['instagram.store'],'method' =>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        {{ Form::text('caption',null,['placeholder' => 'Caption','class' => 'form-control '.($errors->has('caption') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
