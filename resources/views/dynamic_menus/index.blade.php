...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Menu</span>
        <small>
        ...
        <div id="panel-1" class="panel">
            ...
            <h2>
                ...
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('dynamic_menu.create')}}"><i class="fal fa-plus-circle">
                        </i>
